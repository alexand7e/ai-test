...
from app.schemas.agent import AgentConfig, AgentResponse, RAGContext
...
Pergunta: {message.text}"""
        ...
        return AgentResponse(
            ...
            contexts=contexts if 'contexts' in locals() else [], # type: ignore
    ...
    def _prepare_tools(self, agent_config: AgentConfig) -> List[Dict[str, Any]]:
        ...
        return openai_tools if openai_tools else None # type: ignore
