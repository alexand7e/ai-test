...
2. Certifique-se de que o Redis está rodando e configurado no `.env`
...
2. Extrair texto de arquivos DOCX, PDF e XLSX
...
- Arquivos PowerPoint (.pptx) não são suportados atualmente
